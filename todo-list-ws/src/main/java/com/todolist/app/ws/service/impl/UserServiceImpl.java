...
public class UserServiceImpl implements UserService {
	...
	public UserDto createUser(UserDto user) {
		...
		for (int i = 0; i < user.getTodoLists().size(); i++) {
			ToDoListDto todoList = user.getTodoLists().get(i);
			todoList.setUserDetails(user);
			todoList.setTodoListId(utils.generateTodoListId(30));
			user.getTodoLists().set(i, todoList);
		}
